...
(function($) {
    ...
    var searchProto = (function() {
        ...
        // Object containing two-letter ISO country codes as keys
        // and full country names as values
        // Used for converting country codes to full country names
        var isoCountries = {
            'AF' : 'Afghanistan',
            'AX' : 'Aland Islands',
            'AL' : 'Albania',
        ...
        function getStateName(twoLetters) {
            return states[twoLetters];
        }
    ...
    function CitySearch(city) {
        ...
        var searcher = Object.create(searchProto);
        // Expand two letter abbreviated state names for the United State
        // for better API compatibility
        if (/, United States$/.test(city)) {
            city = city.replace(/\s([A-Z]{2}),\s/, function(match, p1) {
                return ' ' + searcher.getStateName(p1) + ', ';
            });
        }
